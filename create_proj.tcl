...
#
# create_proj.tcl: Tcl script for re-creating project 'Zed_Hdmi_Out'
#
#
...
source ./src/tcl/ZED_Hdmi_Out_bd.tcl
...
add_files -norecurse ./$project_name/$project_name.gen/sources_1/bd/$BD_name/hdl/${BD_name}_wrapper.vhd

# Add the wrapper to the fileset
# set obj [get_filesets sources_1]
# set files [list "[file normalize [glob "./$project_name/$project_name.srcs/sources_1/bd/$BD_name/hdl/${BD_name}_wrapper.vhd"]]"]
